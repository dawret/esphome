...
BOOTLOADER_PARTITIONS_UF2_SD6 = [
    {"name": "softdevice", "address": 0x0, "size": 0x26000},
    {"name": "uf2", "address": 0xF4000, "size": 0xC000},
]

BOOTLOADER_PARTITIONS_UF2_SD7 = [
    {"name": "softdevice", "address": 0x0, "size": 0x27000},
    {"name": "uf2", "address": 0xF4000, "size": 0xC000},
]

BOOTLOADER_PARTITION_MAP = {
    BOOTLOADER_ADAFRUIT_UF2_V6: BOOTLOADER_PARTITIONS_UF2_SD6,
    BOOTLOADER_ADAFRUIT_UF2_V7: BOOTLOADER_PARTITIONS_UF2_SD7,
...
BOARD_OVERRIDES = {
    ...
    "xiao_ble": {
        CONF_BOOTLOADER: {
            CONF_TYPE: BOOTLOADER_ADAFRUIT_UF2_V7,
            CONF_PARTITIONS: BOOTLOADER_PARTITIONS_UF2_SD7,
        }
    },
}
